                ...
                {step === 'verify' && (
                  <form onSubmit={handleVerify} className="space-y-6">
                    ...
                    <div className="mt-4 text-center">
                      ...
                      <p className="text-yellow-500/80 text-xs mt-1 mb-2">
                      ...
                      <button
                        type="button"
                        className="relative z-10 text-yellow-500 hover:text-yellow-400 text-sm mt-1 font-medium transition-colors duration-300 flex items-center justify-center mx-auto"
